...
//Config Variables
    ...
    public static final double autoAimTopMotorPowerMultipler = 0.95; //1.125
    public static final double autoAimBottomMotorPowerMultipler = 0.95; //1.125
...
//Controls
    ...
    public static final Button ManualLowShoot = Shooter_controller.getXButton();                //[Shooter Subsystem] (X|Manual Low Shoot)
    public static final Button ManualHighShoot = Shooter_controller.getBButton();               //[Shooter Subsystem] (B|Drop High Ball)
...
// EVEN numbers are angle motors, ODD numbers are drive motors
    ...
    public static final double DRIVETRAIN_FRONT_RIGHT_MODULE_ANGLE_OFFSET = -Math.toRadians(38.5-180);
    ...
    public static final double DRIVETRAIN_BACK_RIGHT_MODULE_ANGLE_OFFSET = -Math.toRadians(291);
    ...
    public static final double DRIVETRAIN_FRONT_LEFT_MODULE_ANGLE_OFFSET = -Math.toRadians(6.5);
