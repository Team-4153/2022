...
public class TestCommand extends SequentialCommandGroup{
    public TestCommand(DrivetrainSubsystem drivetrain, ShooterSubsystem2 shooter, IntakeSubsystem intake, ClimberSubsystem climb) {
        addCommands(
            ...
            new DriveCommand(drivetrain, () -> 0, () -> 0.5, () -> 0, () -> 0, () -> 0).withTimeout(1),
            new DriveCommand(drivetrain, () -> 0, () -> 0, () -> 0, () -> 0, () -> 0).withTimeout(0.5),

            new IntakeCommand(intake, false).withTimeout(1),
            ...
            new UnspoolCommand(climb).withTimeout(0.3),
            new SpoolCommand(climb).withTimeout(0.3),
