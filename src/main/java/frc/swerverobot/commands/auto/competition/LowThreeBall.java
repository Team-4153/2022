...
public class LowThreeBall extends SequentialCommandGroup{
    ...
    public LowThreeBall(DrivetrainSubsystem drivetrain, ShooterSubsystem2 shooter, IntakeSubsystem intake) {
        ...
        addCommands(
            new ManualShoot(shooter, -0.5, 0.5, -1).withTimeout(1.3),                                       //Shoot 1st ball
            new IntakeCommand(intake, false).withTimeout(0.1),                                              //Extend Intake
            new DriveCommand(drivetrain, () -> -0.5, () -> 0, () -> 0, () -> 0, () -> 0).withTimeout(0.95), //Drive Backwards
            ...
            new ManualShoot(shooter, -0.5, 0.7, -1),                                                        //Shoot both balls into low goal
            ...
            new DriveCommand(drivetrain, () -> 0.1, () -> 0.5, () -> 0, () -> 0, () -> 0).withTimeout(1.5), //Drive to 3rd ball
            ...
            new ManualShoot(shooter, -0.5, 0.75, -1),                                                       //Shoot 3rd ball into low goal
