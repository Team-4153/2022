...
//SmartDashboard.getNumber("TargetOff", 0)
  ...
  */
  ...
  public void periodic() {
    ...
    rainbow(lengthstrand1 + lengthstrandlefty + lengthstrand2, lengthstrandrighty);//Right Y
    rainbow(lengthstrand1 + lengthstrandlefty + lengthstrand2 + lengthstrandrighty, lengthstrand3);//Third Strand
