...
public class Mk2SwerveModule extends SwerveModule {
    ...
    private static final PidConstants ANGLE_CONSTANTS = new PidConstants(0.5, 0.0, 0.001);
    ...
    private CANAnalog angleEncoder;
    ...
    public Mk2SwerveModule(Vector2 modulePosition, double angleOffset,
                           CANSparkMax angleMotor, CANSparkMax driveMotor, CANAnalog angleEncoder) { //changed AnalogInput to CANAnalog
        super(modulePosition);
        this.angleOffset = angleOffset;
        this.steeringMotor = angleMotor;
        //this.angleEncoder = steeringMotor.getAnalog(AnalogMode.kAbsolute);
    ...
    protected double readAngle() {
        //double angle = (angleEncoder.getPosition()/3.35) * 2.0 * Math.PI + angleOffset ;
